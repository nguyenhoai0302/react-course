...
const STUDENTS_DATA = [
    { firstName: "An", lastName: "Trường", batch: 1, age: 20 },
    { firstName: "Bình", lastName: "Thanh", batch: 2, age: 22 },
    { firstName: "Cẩm", lastName: "Lê", batch: 3, age: 21 },
    { firstName: "An", lastName: "Vũ", batch: 4, age: 19 }, // Duplicate first name !
  ]; 
...
function updateStudentAge(firstName, lastName, batch, newAge) {
  let student = STUDENTS_DATA.find((s) => s.firstName === firstName && s.firstName === firstName && s.batch === batch);
  if (student) {
    student.age = newAge;
  }
}
...
updateStudentAge("An", "Trường", 1, 30);
